...
export default class RamGraph extends Component {
    ...
    getMemoryUsageHistory() {
        ...
        for (let x = 0; x < history.length - 10; x++) {
            ...
            // console.log(transformUsageToPercent)
    ...
    generate_svg() {
        ...
        var point_x_axis = 0;
        this.last_sum = parseInt(selectedMachineHistory[selectedMachineHistory.length - 21])
        // console.log(this.last_sum)
        for (let x = selectedMachineHistory.length - 1; x >= 0; x--) {
            ...
            // 
            // console.log(this.svg_inner['height']-point_y_axis_selectedMachineHistory)
